...
/** @defgroup FLASH_Sectors
  * @{
  */
#define FLASH_Sector_0     ((uint16_t)0x0000) /*!< Sector Number 0   */    //0000£¬0000
#define FLASH_Sector_1     ((uint16_t)0x0008) /*!< Sector Number 1   */    //0000£¬1000
#define FLASH_Sector_2     ((uint16_t)0x0010) /*!< Sector Number 2   */    //0001£¬0000
#define FLASH_Sector_3     ((uint16_t)0x0018) /*!< Sector Number 3   */    //0001£¬1000
#define FLASH_Sector_4     ((uint16_t)0x0020) /*!< Sector Number 4   */    //0010£¬0000
#define FLASH_Sector_5     ((uint16_t)0x0028) /*!< Sector Number 5   */    //0010£¬1000
#define FLASH_Sector_6     ((uint16_t)0x0030) /*!< Sector Number 6   */    //0011£¬0000
#define FLASH_Sector_7     ((uint16_t)0x0038) /*!< Sector Number 7   */    //0011£¬1000
#define FLASH_Sector_8     ((uint16_t)0x0040) /*!< Sector Number 8   */    //0100£¬0000
#define FLASH_Sector_9     ((uint16_t)0x0048) /*!< Sector Number 9   */    //0100£¬1000
#define FLASH_Sector_10    ((uint16_t)0x0050) /*!< Sector Number 10  */    //0101£¬0000
#define FLASH_Sector_11    ((uint16_t)0x0058) /*!< Sector Number 11  */    //0101£¬1000
#define FLASH_Sector_12    ((uint16_t)0x0080) /*!< Sector Number 12  */    //1000£¬0000
#define FLASH_Sector_13    ((uint16_t)0x0088) /*!< Sector Number 13  */    //1000£¬1000
#define FLASH_Sector_14    ((uint16_t)0x0090) /*!< Sector Number 14  */    //1001£¬0000
#define FLASH_Sector_15    ((uint16_t)0x0098) /*!< Sector Number 15  */    //1001£¬1000
#define FLASH_Sector_16    ((uint16_t)0x00A0) /*!< Sector Number 16  */    //1010£¬0000
#define FLASH_Sector_17    ((uint16_t)0x00A8) /*!< Sector Number 17  */    //1010£¬1000
#define FLASH_Sector_18    ((uint16_t)0x00B0) /*!< Sector Number 18  */    //1011£¬0000
#define FLASH_Sector_19    ((uint16_t)0x00B8) /*!< Sector Number 19  */    //1011£¬1000
#define FLASH_Sector_20    ((uint16_t)0x00C0) /*!< Sector Number 20  */    //1100£¬0000
#define FLASH_Sector_21    ((uint16_t)0x00C8) /*!< Sector Number 21  */    //1100£¬1000
#define FLASH_Sector_22    ((uint16_t)0x00D0) /*!< Sector Number 22  */    //1101£¬0000
#define FLASH_Sector_23    ((uint16_t)0x00D8) /*!< Sector Number 23  */    //1101£¬1000
